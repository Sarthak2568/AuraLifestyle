        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-4">
          ...
          <div>
            ...
            <div className="mt-4 flex items-center gap-3 text-neutral-500">
              <a href="#" className="hover:text-emerald-600 dark:hover:text-emerald-400" aria-label="Instagram">IG</a>
              <a href="#" className="hover:text-emerald-600 dark:hover:text-emerald-400" aria-label="Facebook">FB</a>
              <a href="#" className="hover:text-emerald-600 dark:hover:text-emerald-400" aria-label="X">X</a>
              <a href="#" className="hover:text-emerald-600 dark:hover:text-emerald-400" aria-label="Snapchat">SC</a>
            </div>
          </div>
